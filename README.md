...
- Interactive project carousel with GitHub links
- Modern glassmorphism contact section
...
### 1. Automated Git-Based Deployment Platform
Cloud-Native CI/CD from Git Repositories  
**Tech:** AWS, Kafka, ClickHouse, PostgreSQL, Next.js, Docker  
Reduced manual deployment effort by 80%

### 2. AI-Powered Resume Analyzer & Job Matcher
Semantic Resume Evaluation and Job Matching  
**Tech:** Next.js, GraphQL, Kafka, PostgreSQL, Redis, LLM  
Built scalable async processing and semantic scoring

### 3. Policy Pulse
AI-Powered Policy Simulation Platform  
**Tech:** Python, Scikit-learn, Streamlit, Gemini API  
Simulated up to 50,000 virtual citizens for policy impact analysis

### 4. Event Pass
College Event Management System  
**Tech:** MERN Stack, QR Verification, Real-Time Validation  
Handled 1,000+ registrations with 99.2% uptime
...
- **Projects**: Update the `projects` array in `Work.tsx` with your own projects, images, and GitHub links.
